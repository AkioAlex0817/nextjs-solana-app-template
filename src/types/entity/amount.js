...
var H = (i, o, n) => (o in i ? N(i, o, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (i[o] = n)),
  C = (i, o) => {
    for (var n in o || (o = {})) G.call(o, n) && H(i, n, o[n])
    if (K) for (var n of K(o)) Le.call(o, n) && H(i, n, o[n])
    return i
  }
var Re = (i, o) => {
    for (var n in o) N(i, n, { get: o[n], enumerable: !0 })
  },
  X = (i, o, n, s) => {
    if ((o && typeof o == 'object') || typeof o == 'function')
      for (let t of ye(o))
        !G.call(i, t) && t !== n && N(i, t, { get: () => o[t], enumerable: !(s = Ue(o, t)) || s.enumerable })
    return i
  }
var p = (i, o, n) => (
    (n = i != null ? pe(Ce(i)) : {}), X(o || !i || !i.__esModule ? N(n, 'default', { value: i, enumerable: !0 }) : n, i)
  ),
  Te = (i) => X(N({}, '__esModule', { value: !0 }), i)
var Ie = {}
Re(Ie, { CurrencyAmount: () => T, TokenAmount: () => E, splitNumber: () => ue })
module.exports = Te(Ie)
var de = p(require('big.js')),
  k = p(require('bn.js'))
var Ae = require('@solana/web3.js')
var A = require('@solana/web3.js')
var $ = require('@solana/web3.js')
var Y = '1.1.0-beta.0'
var Me = require('@colors/colors'),
  j = !1,
  z = !1,
...
function oe(i, o = !1) {
  ...
  try {
    if (i instanceof Uint8Array) {
      let s = ''
      for (let t = 0; t < i.length; t++) (s += Z[i[t] >> 4]), (s += Z[i[t] & 15])
      n = `Uint8Array(0x${s})`
    } else if (i instanceof $.PublicKey) n = `PublicKey(${i.toBase58()})`
...
var r = class {
    ...
    _log(o, n) {
      let s = o.toLowerCase()
      h[s] == null && this.throwArgumentError('invalid log level name', 'logLevel', o),
        !((J[this.moduleName] || h.default) > h[s]) && console.log(...n)
    }
    debug(...o) {
      this._log(r.levels.DEBUG, ['[DEBUG]'.blue, ...o])
    }
    info(...o) {
      this._log(r.levels.INFO, ['[INFO]'.green, ...o])
    }
    warn(...o) {
      this._log(r.levels.WARNING, ['[WARN]'.yellow, ...o])
    }
    makeError(o, n, s) {
      if (z) return this.makeError('censored error', n, {})
      n || (n = r.errors.UNKNOWN_ERROR), s || (s = {})
      let t = []
    ...
    throwArgumentError(o, n, s) {
      return this.throwError(o, r.errors.INVALID_ARGUMENT, { argument: n, value: s })
    }
    assert(o, n, s, t) {
    ...
    checkNormalize(o) {
      o == null && (o = 'platform missing String.prototype.normalize'),
        Q &&
          this.throwError('platform missing String.prototype.normalize', r.errors.UNSUPPORTED_OPERATION, {
    ...
    checkSafeUint53(o, n) {
      typeof o == 'number' &&
        ...
        (o < 0 || o >= 9007199254740991) &&
          this.throwError(n, r.errors.NUMERIC_FAULT, {
            operation: 'checkSafeInteger',
            fault: 'out-of-safe-range',
            value: o
          }),
        o % 1 &&
          this.throwError(n, r.errors.NUMERIC_FAULT, { operation: 'checkSafeInteger', fault: 'non-integer', value: o }))
    }
    checkArgumentCount(o, n, s) {
      s ? (s = ': ' + s) : (s = ''),
        o < n && this.throwError('missing argument' + s, r.errors.MISSING_ARGUMENT, { count: o, expectedCount: n }),
        o > n && this.throwError('too many arguments' + s, r.errors.UNEXPECTED_ARGUMENT, { count: o, expectedCount: n })
    }
    checkNew(o, n) {
      ;(o === Object || o == null) && this.throwError('missing new', r.errors.MISSING_NEW, { name: n.name })
    }
    checkAbstract(o, n) {
      o === n
        ? this.throwError(
    ...
    static globalLogger() {
      return v || (v = new r(Y)), v
    }
    static setCensorship(o, n) {
      if (
        (!o &&
          n &&
          this.globalLogger().throwError('cannot permanently disable censorship', r.errors.UNSUPPORTED_OPERATION, {
    ...
    static setLogLevel(o, n) {
      let s = h[n.toLowerCase()]
      if (s == null) {
        r.globalLogger().warn('invalid log level - ' + n)
        return
      }
      J[o] = s
    }
  ...
  c = r
;(c.errors = ne), (c.levels = ee)
var se = require('@solana/spl-token'),
  te = require('@solana/web3.js'),
  ie = c.from('common/pubkey'),
  ve = A.SystemProgram.programId,
  Be = new A.PublicKey('Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo')
function B(i) {
  ...
  if (typeof i == 'string')
    try {
      ...
      return ie.throwArgumentError('invalid public key', 'publicKey', i)
    }
  return ie.throwArgumentError('invalid public key', 'publicKey', i)
}
var fe = require('@solana/web3.js'),
  Pe = p(require('bn.js'))
var W = require('@solana/web3.js')
var nn = c.from('common/web3')
var V = p(require('bn.js'))
var u = p(require('bn.js'))
var un = new u.default(0),
  me = new u.default(1),
  bn = new u.default(2),
  Dn = new u.default(3),
  pn = new u.default(5),
  q = new u.default(10),
  Un = new u.default(100),
  yn = new u.default(1e3),
  Cn = new u.default(1e4)
var x = c.from('entity/bignumber'),
  re = 9007199254740991
function d(i) {
  return i instanceof V.default
    ? i
    : typeof i == 'string'
    ? i.match(/^-?[0-9]+$/)
      ? new V.default(i)
      : x.throwArgumentError('invalid BigNumberish string', 'value', i)
    : typeof i == 'number'
    ? i % 1
      ? x.throwArgumentError('BigNumberish number underflow', 'value', i)
      : i >= re || i <= -re
      ? x.throwArgumentError('BigNumberish number overflow', 'value', i)
      : new V.default(String(i))
    : typeof i == 'bigint'
    ? new V.default(i.toString())
    : x.throwArgumentError('invalid BigNumberish value', 'value', i)
}
var f = { symbol: 'SOL', name: 'Solana', decimals: 9 },
  b = {
    symbol: 'WSOL',
    name: 'Wrapped SOL',
...
var _ = class {
  ...
  M = _
M.SOL = new _(f.decimals, f.symbol, f.name)
var F = class extends M {
  ...
  L = F
L.WSOL = new F(b.mint, b.decimals, f.symbol, f.name)
function R(i, o) {
  return i instanceof L && o instanceof L ? i.equals(o) : i instanceof L || o instanceof L ? !1 : i === o
}
var ce = p(require('big.js')),
  le = p(require('decimal.js-light'))
var ae = p(require('toformat')),
  Ee = ae.default,
  O = Ee
var w = c.from('entity/fraction'),
  P = O(ce.default),
  I = O(le.default),
  Ve = { [0]: I.ROUND_DOWN, [1]: I.ROUND_HALF_UP, [2]: I.ROUND_UP },
  Oe = { [0]: P.roundDown, [1]: P.roundHalfUp, [2]: P.roundUp },
  a = class {
    constructor(o, n = me) {
    ...
    invert() {
      return new a(this.denominator, this.numerator)
    }
    add(o) {
      let n = o instanceof a ? o : new a(d(o))
      return this.denominator.eq(n.denominator)
        ? new a(this.numerator.add(n.numerator), this.denominator)
        : new a(
    ...
    sub(o) {
      let n = o instanceof a ? o : new a(d(o))
      return this.denominator.eq(n.denominator)
        ? new a(this.numerator.sub(n.numerator), this.denominator)
        : new a(
    ...
    mul(o) {
      let n = o instanceof a ? o : new a(d(o))
      return new a(this.numerator.mul(n.numerator), this.denominator.mul(n.denominator))
    }
    div(o) {
      let n = o instanceof a ? o : new a(d(o))
      return new a(this.numerator.mul(n.denominator), this.denominator.mul(n.numerator))
    }
    toSignificant(o, n = { groupSeparator: '' }, s = 1) {
      w.assert(Number.isInteger(o), `${o} is not an integer.`),
        w.assert(o > 0, `${o} is not positive.`),
        I.set({ precision: o + 1, rounding: Ve[s] })
      let t = new I(this.numerator.toString()).div(this.denominator.toString()).toSignificantDigits(o)
    ...
    toFixed(o, n = { groupSeparator: '' }, s = 1) {
      return (
        ...
        (P.DP = o),
        (P.RM = Oe[s]),
        new P(this.numerator.toString()).div(this.denominator.toString()).toFormat(o, n)
      )
    }
  }
var U = c.from('entity/amount'),
  Se = O(de.default)
function ue(i, o) {
  let n = '0',
    s = '0'
  if (i.includes('.')) {
    ...
    else return U.throwArgumentError('invalid number string', 'num', i)
  } else n = i
  return [n, s.slice(0, o) || s]
}
var T = class extends a {
    constructor(n, s, t = !0) {
      let l = new k.default(0),
        y = q.pow(new k.default(n.decimals))
      if (t) l = d(s)
      else {
        let D = new k.default(0),
          g = new k.default(0)
        if (typeof s == 'string' || typeof s == 'number' || typeof s == 'bigint') {
          let [be, De] = ue(s.toString(), n.decimals)
          ;(D = d(be)), (g = d(De))
        }
        ;(D = D.mul(y)), (l = D.add(g))
      }
    ...
    gt(n) {
      return U.assert(R(this.currency, n.currency), 'gt currency not equals'), this.raw.gt(n.raw)
    }
    lt(n) {
      return U.assert(R(this.currency, n.currency), 'lt currency not equals'), this.raw.lt(n.raw)
    }
    add(n) {
      return (
        U.assert(R(this.currency, n.currency), 'add currency not equals'), new T(this.currency, this.raw.add(n.raw))
      )
    }
    sub(n) {
      return (
        U.assert(R(this.currency, n.currency), 'sub currency not equals'), new T(this.currency, this.raw.sub(n.raw))
      )
    }
    ...
    toFixed(n = this.currency.decimals, s, t = 0) {
      return U.assert(n <= this.currency.decimals, 'decimals overflow'), super.toFixed(n, s, t)
    }
    toExact(n = { groupSeparator: '' }) {
      return (
        (Se.DP = this.currency.decimals), new Se(this.numerator.toString()).div(this.denominator.toString()).toFormat(n)
      )
    }
  },
  E = class extends T {
    ...
    add(n) {
      return U.assert(R(this.token, n.token), 'add token not equals'), new E(this.token, this.raw.add(n.raw))
    }
    subtract(n) {
      return U.assert(R(this.token, n.token), 'sub token not equals'), new E(this.token, this.raw.sub(n.raw))
    }
  }
0 && (module.exports = { CurrencyAmount, TokenAmount, splitNumber })
