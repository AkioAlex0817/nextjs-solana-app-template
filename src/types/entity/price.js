...
var q = (i, n, o) => (n in i ? T(i, n, { enumerable: !0, configurable: !0, writable: !0, value: o }) : (i[n] = o)),
  D = (i, n) => {
    for (var o in n || (n = {})) _.call(n, o) && q(i, o, n[o])
    if (W) for (var o of W(n)) ue.call(n, o) && q(i, o, n[o])
    return i
  }
var be = (i, n) => {
    for (var o in n) T(i, o, { get: n[o], enumerable: !0 })
  },
  F = (i, n, o, s) => {
    if ((n && typeof n == 'object') || typeof n == 'function')
      for (let t of Se(n))
        !_.call(i, t) && t !== o && T(i, t, { get: () => n[t], enumerable: !(s = le(n, t)) || s.enumerable })
    return i
  }
var p = (i, n, o) => (
    (o = i != null ? ce(de(i)) : {}), F(n || !i || !i.__esModule ? T(o, 'default', { value: i, enumerable: !0 }) : o, i)
  ),
  De = (i) => F(T({}, '__esModule', { value: !0 }), i)
var ge = {}
be(ge, { Price: () => R })
module.exports = De(ge)
var pe = require('@solana/web3.js')
var y = require('@solana/web3.js')
var z = require('@solana/web3.js')
var k = '1.1.0-beta.0'
var Ne = require('@colors/colors'),
  K = !1,
  H = !1,
  P = { debug: 1, default: 2, info: 2, warning: 3, error: 4, off: 5 },
  G = {},
  M
function Ue() {
  try {
    let i = []
    if (
      (['NFD', 'NFC', 'NFKD', 'NFKC'].forEach((n) => {
        try {
          if ('test'.normalize(n) !== 'test') throw new Error('bad normalize')
        } catch {
          i.push(n)
        }
      }),
...
function Z(i, n = !1) {
  ...
  try {
    if (i instanceof Uint8Array) {
      let s = ''
      for (let t = 0; t < i.length; t++) (s += j[i[t] >> 4]), (s += j[i[t] & 15])
      o = `Uint8Array(0x${s})`
    } else if (i instanceof z.PublicKey) o = `PublicKey(${i.toBase58()})`
    else if (i instanceof Object && !n) {
      let s = {}
      Object.entries(i).forEach(([t, l]) => {
        s[t] = Z(l, !0)
      }),
        (o = JSON.stringify(s))
    } else n || (o = JSON.stringify(i))
  } catch {
    o = JSON.stringify(i.toString())
  }
  return o
}
var a = class {
    ...
    _log(n, o) {
      let s = n.toLowerCase()
      P[s] == null && this.throwArgumentError('invalid log level name', 'logLevel', n),
        !((G[this.moduleName] || P.default) > P[s]) && console.log(...o)
    }
    debug(...n) {
      this._log(a.levels.DEBUG, ['[DEBUG]'.blue, ...n])
    }
    info(...n) {
      this._log(a.levels.INFO, ['[INFO]'.green, ...n])
    }
    warn(...n) {
      this._log(a.levels.WARNING, ['[WARN]'.yellow, ...n])
    }
    makeError(n, o, s) {
      if (H) return this.makeError('censored error', o, {})
      o || (o = a.errors.UNKNOWN_ERROR), s || (s = {})
      let t = []
    ...
    throwError(n, o, s) {
      throw this.makeError(n, o, s)
    }
    throwArgumentError(n, o, s) {
      return this.throwError(n, a.errors.INVALID_ARGUMENT, { argument: o, value: s })
    }
    assert(n, o, s, t) {
      n || this.throwError(o, s, t)
    }
    assertArgument(n, o, s, t) {
      n || this.throwArgumentError(o, s, t)
    }
    checkNormalize(n) {
      n == null && (n = 'platform missing String.prototype.normalize'),
        X &&
    ...
    checkSafeUint53(n, o) {
      typeof n == 'number' &&
        (o == null && (o = 'value not safe'),
        (n < 0 || n >= 9007199254740991) &&
          this.throwError(o, a.errors.NUMERIC_FAULT, {
            operation: 'checkSafeInteger',
            fault: 'out-of-safe-range',
            value: n
          }),
        n % 1 &&
          this.throwError(o, a.errors.NUMERIC_FAULT, { operation: 'checkSafeInteger', fault: 'non-integer', value: n }))
    }
    checkArgumentCount(n, o, s) {
      s ? (s = ': ' + s) : (s = ''),
        n < o && this.throwError('missing argument' + s, a.errors.MISSING_ARGUMENT, { count: n, expectedCount: o }),
        n > o && this.throwError('too many arguments' + s, a.errors.UNEXPECTED_ARGUMENT, { count: n, expectedCount: o })
    }
    checkNew(n, o) {
      ;(n === Object || n == null) && this.throwError('missing new', a.errors.MISSING_NEW, { name: o.name })
    }
    checkAbstract(n, o) {
      n === o
        ? this.throwError(
            'cannot instantiate abstract class ' + JSON.stringify(o.name) + ' directly; use a sub-class',
            a.errors.UNSUPPORTED_OPERATION,
            { name: n.name, operation: 'new' }
          )
        : (n === Object || n == null) && this.throwError('missing new', a.errors.MISSING_NEW, { name: o.name })
    }
    static globalLogger() {
      return M || (M = new a(k)), M
    }
    static setCensorship(n, o) {
      if (
        (!n &&
          o &&
    ...
    static setLogLevel(n, o) {
      let s = P[o.toLowerCase()]
      if (s == null) {
        a.globalLogger().warn('invalid log level - ' + o)
        return
      }
      G[n] = s
    }
  ...
  c = a
;(c.errors = Q), (c.levels = J)
var ee = require('@solana/spl-token'),
  ne = require('@solana/web3.js'),
  $ = c.from('common/pubkey'),
  Ie = y.SystemProgram.programId,
  ke = new y.PublicKey('Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo')
function x(i) {
  if (i instanceof y.PublicKey) return i
  if (typeof i == 'string')
    try {
      return new y.PublicKey(i)
    } catch {
      return $.throwArgumentError('invalid public key', 'publicKey', i)
    }
  return $.throwArgumentError('invalid public key', 'publicKey', i)
}
...
var je = c.from('common/web3')
var A = p(require('bn.js'))
var d = p(require('bn.js'))
var mn = new d.default(0),
  oe = new d.default(1),
  rn = new d.default(2),
  an = new d.default(3),
  cn = new d.default(5),
  ie = new d.default(10),
  ln = new d.default(100),
  Sn = new d.default(1e3),
  dn = new d.default(1e4)
var E = c.from('entity/bignumber'),
  se = 9007199254740991
function b(i) {
  return i instanceof A.default
    ? i
    : typeof i == 'string'
    ? i.match(/^-?[0-9]+$/)
      ? new A.default(i)
      : E.throwArgumentError('invalid BigNumberish string', 'value', i)
    : typeof i == 'number'
    ? i % 1
      ? E.throwArgumentError('BigNumberish number underflow', 'value', i)
      : i >= se || i <= -se
      ? E.throwArgumentError('BigNumberish number overflow', 'value', i)
      : new A.default(String(i))
    : typeof i == 'bigint'
    ? new A.default(i.toString())
    : E.throwArgumentError('invalid BigNumberish value', 'value', i)
}
function Y(i) {
  return ie.pow(b(i))
}
var C = { symbol: 'SOL', name: 'Solana', decimals: 9 },
  u = {
    symbol: 'WSOL',
    name: 'Wrapped SOL',
...
var On = c.from('token/util')
var w = class {
    constructor(n, o = 'UNKNOWN', s = 'UNKNOWN') {
      ;(this.decimals = n), (this.symbol = o), (this.name = s)
    }
  },
  N = w
N.SOL = new w(C.decimals, C.symbol, C.name)
var v = class extends N {
    constructor(o, s, t = 'UNKNOWN', l = 'UNKNOWN') {
      super(s, t, l)
      this.mint = x(o)
    }
    equals(o) {
      return this === o ? !0 : this.mint.equals(o.mint)
    }
  },
  U = v
U.WSOL = new v(u.mint, u.decimals, C.symbol, C.name)
function te(i, n) {
  return i instanceof U && n instanceof U ? i.equals(n) : i instanceof U || n instanceof U ? !1 : i === n
}
var re = p(require('big.js')),
  ae = p(require('decimal.js-light'))
var me = p(require('toformat')),
  Le = me.default,
  B = Le
var V = c.from('entity/fraction'),
  L = B(re.default),
  g = B(ae.default),
  Re = { [0]: g.ROUND_DOWN, [1]: g.ROUND_HALF_UP, [2]: g.ROUND_UP },
  Te = { [0]: L.roundDown, [1]: L.roundHalfUp, [2]: L.roundUp },
  r = class {
    constructor(n, o = oe) {
      ;(this.numerator = b(n)), (this.denominator = b(o))
    }
    get quotient() {
    ...
    add(n) {
      let o = n instanceof r ? n : new r(b(n))
      return this.denominator.eq(o.denominator)
        ? new r(this.numerator.add(o.numerator), this.denominator)
        : new r(
            this.numerator.mul(o.denominator).add(o.numerator.mul(this.denominator)),
            this.denominator.mul(o.denominator)
          )
    }
    sub(n) {
      let o = n instanceof r ? n : new r(b(n))
      return this.denominator.eq(o.denominator)
        ? new r(this.numerator.sub(o.numerator), this.denominator)
        : new r(
            this.numerator.mul(o.denominator).sub(o.numerator.mul(this.denominator)),
            this.denominator.mul(o.denominator)
          )
    }
    mul(n) {
      let o = n instanceof r ? n : new r(b(n))
      return new r(this.numerator.mul(o.numerator), this.denominator.mul(o.denominator))
    }
    div(n) {
      let o = n instanceof r ? n : new r(b(n))
      return new r(this.numerator.mul(o.denominator), this.denominator.mul(o.numerator))
    }
    toSignificant(n, o = { groupSeparator: '' }, s = 1) {
      V.assert(Number.isInteger(n), `${n} is not an integer.`),
        V.assert(n > 0, `${n} is not positive.`),
        g.set({ precision: n + 1, rounding: Re[s] })
      let t = new g(this.numerator.toString()).div(this.denominator.toString()).toSignificantDigits(n)
      return t.toFormat(t.decimalPlaces(), o)
    }
    toFixed(n, o = { groupSeparator: '' }, s = 1) {
      return (
        V.assert(Number.isInteger(n), `${n} is not an integer.`),
        V.assert(n >= 0, `${n} is negative.`),
        (L.DP = n),
        (L.RM = Te[s]),
        new L(this.numerator.toString()).div(this.denominator.toString()).toFormat(n, o)
      )
    }
  }
var Ae = c.from('entity/price'),
  R = class extends r {
    constructor(o, s, t, l) {
      super(l, s)
      ;(this.baseCurrency = o), (this.quoteCurrency = t), (this.scalar = new r(Y(o.decimals), Y(t.decimals)))
    }
    get raw() {
    ...
    invert() {
      return new R(this.quoteCurrency, this.numerator, this.baseCurrency, this.denominator)
    }
    mul(o) {
      Ae.assert(te(this.quoteCurrency, o.baseCurrency), 'mul currency not equals')
      let s = super.mul(o)
      return new R(this.baseCurrency, s.denominator, o.quoteCurrency, s.numerator)
    }
    toSignificant(o = this.quoteCurrency.decimals, s, t) {
      return this.adjusted.toSignificant(o, s, t)
    }
    toFixed(o = this.quoteCurrency.decimals, s, t) {
      return this.adjusted.toFixed(o, s, t)
    }
  }
0 && (module.exports = { Price })
