...
var V = (s, n, o) => (n in s ? y(s, n, { enumerable: !0, configurable: !0, writable: !0, value: o }) : (s[n] = o)),
  U = (s, n) => {
    for (var o in n || (n = {})) I.call(n, o) && V(s, o, n[o])
    if (N) for (var o of N(n)) j.call(n, o) && V(s, o, n[o])
    return s
  }
var J = (s, n) => {
    for (var o in n) y(s, o, { get: n[o], enumerable: !0 })
  },
  O = (s, n, o, i) => {
    if ((n && typeof n == 'object') || typeof n == 'function')
      for (let t of H(n))
        !I.call(s, t) && t !== o && y(s, t, { get: () => n[t], enumerable: !(i = B(n, t)) || i.enumerable })
    return s
  }
var z = (s, n, o) => (
    (o = s != null ? G(X(s)) : {}), O(n || !s || !s.__esModule ? y(o, 'default', { value: s, enumerable: !0 }) : o, s)
  ),
  Q = (s) => O(y({}, '__esModule', { value: !0 }), s)
var te = {}
J(te, {
  Currency: () => b,
  Token: () => S,
...
var D = require('@solana/web3.js')
var w = require('@solana/web3.js')
var A = '1.1.0-beta.0'
var ce = require('@colors/colors'),
  M = !1,
  k = !1,
...
var x = Z(),
  h = ((c) => (
    (c.DEBUG = 'DEBUG'), (c.INFO = 'INFO'), (c.WARNING = 'WARNING'), (c.ERROR = 'ERROR'), (c.OFF = 'OFF'), c
  ))(h || {}),
  q = ((r) => (
...
function _(s, n = !1) {
  ...
  try {
    if (s instanceof Uint8Array) {
      let i = ''
      for (let t = 0; t < s.length; t++) (i += v[s[t] >> 4]), (i += v[s[t] & 15])
      o = `Uint8Array(0x${i})`
    } else if (s instanceof w.PublicKey) o = `PublicKey(${s.toBase58()})`
    else if (s instanceof Object && !n) {
      let i = {}
      Object.entries(s).forEach(([t, c]) => {
        i[t] = _(c, !0)
      }),
        (o = JSON.stringify(i))
    } else n || (o = JSON.stringify(s))
  } catch {
    o = JSON.stringify(s.toString())
  }
  return o
}
var m = class {
    ...
    _log(n, o) {
      let i = n.toLowerCase()
      u[i] == null && this.throwArgumentError('invalid log level name', 'logLevel', n),
        !((Y[this.moduleName] || u.default) > u[i]) && console.log(...o)
    }
    debug(...n) {
      this._log(m.levels.DEBUG, ['[DEBUG]'.blue, ...n])
    }
    info(...n) {
      this._log(m.levels.INFO, ['[INFO]'.green, ...n])
    }
    warn(...n) {
      this._log(m.levels.WARNING, ['[WARN]'.yellow, ...n])
    }
    makeError(n, o, i) {
      if (k) return this.makeError('censored error', o, {})
      o || (o = m.errors.UNKNOWN_ERROR), i || (i = {})
      let t = []
    ...
    throwError(n, o, i) {
      throw this.makeError(n, o, i)
    }
    throwArgumentError(n, o, i) {
      return this.throwError(n, m.errors.INVALID_ARGUMENT, { argument: o, value: i })
    }
    assert(n, o, i, t) {
      n || this.throwError(o, i, t)
    }
    assertArgument(n, o, i, t) {
      n || this.throwArgumentError(o, i, t)
    }
    checkNormalize(n) {
      n == null && (n = 'platform missing String.prototype.normalize'),
        x &&
          this.throwError('platform missing String.prototype.normalize', m.errors.UNSUPPORTED_OPERATION, {
    ...
    checkSafeUint53(n, o) {
      typeof n == 'number' &&
        ...
        (n < 0 || n >= 9007199254740991) &&
          this.throwError(o, m.errors.NUMERIC_FAULT, {
            operation: 'checkSafeInteger',
            fault: 'out-of-safe-range',
            value: n
          }),
        n % 1 &&
          this.throwError(o, m.errors.NUMERIC_FAULT, { operation: 'checkSafeInteger', fault: 'non-integer', value: n }))
    }
    checkArgumentCount(n, o, i) {
      i ? (i = ': ' + i) : (i = ''),
        n < o && this.throwError('missing argument' + i, m.errors.MISSING_ARGUMENT, { count: n, expectedCount: o }),
        n > o && this.throwError('too many arguments' + i, m.errors.UNEXPECTED_ARGUMENT, { count: n, expectedCount: o })
    }
    checkNew(n, o) {
      ;(n === Object || n == null) && this.throwError('missing new', m.errors.MISSING_NEW, { name: o.name })
    }
    checkAbstract(n, o) {
      n === o
        ? this.throwError(
    ...
    static globalLogger() {
      return P || (P = new m(A)), P
    }
    static setCensorship(n, o) {
      if (
        (!n &&
          o &&
          this.globalLogger().throwError('cannot permanently disable censorship', m.errors.UNSUPPORTED_OPERATION, {
    ...
    static setLogLevel(n, o) {
      let i = u[o.toLowerCase()]
      if (i == null) {
        m.globalLogger().warn('invalid log level - ' + o)
        return
      }
      Y[n] = i
    }
  ...
  l = m
;(l.errors = q), (l.levels = h)
var F = require('@solana/spl-token'),
  W = require('@solana/web3.js'),
  K = l.from('common/pubkey'),
  de = D.SystemProgram.programId,
  be = new D.PublicKey('Memo1UhkJRfHyvLMcVucJwxXeuD728EqVDDwQDxFMNo')
function E(s) {
  if (s instanceof D.PublicKey) return s
  if (typeof s == 'string')
    try {
      return new D.PublicKey(s)
    } catch {
      return K.throwArgumentError('invalid public key', 'publicKey', s)
    }
  return K.throwArgumentError('invalid public key', 'publicKey', s)
}
var ee = require('@solana/web3.js'),
  ne = z(require('bn.js'))
var f = require('@solana/web3.js')
var Ve = l.from('common/web3')
...
var $e = l.from('token/util')
var p = class {
    constructor(n, o = 'UNKNOWN', i = 'UNKNOWN') {
      ;(this.decimals = n), (this.symbol = o), (this.name = i)
    }
  },
  b = p
b.SOL = new p(C.decimals, C.symbol, C.name)
function oe() {
  if (typeof Symbol < 'u' && typeof Symbol.for == 'function')
    try {
      b.prototype[Symbol.for('nodejs.util.inspect.custom')] = function () {
...
var g = class extends b {
    constructor(o, i, t = 'UNKNOWN', c = 'UNKNOWN') {
      super(i, t, c)
      this.mint = E(o)
    }
    equals(o) {
  ...
  S = g
S.WSOL = new g(d.mint, d.decimals, C.symbol, C.name)
function se() {
  if (typeof Symbol < 'u' && typeof Symbol.for == 'function')
    try {
...
function ie(s, n) {
  return s instanceof S && n instanceof S ? s.equals(n) : s instanceof S || n instanceof S ? !1 : s === n
}
0 && (module.exports = { Currency, Token, currencyEquals, inspectCurrency, inspectToken })
